    ...
    public class SerializationTest {
        ...
        public void SerialiseTest() {
            ...
            model.Clients = new List<Client>() {
                new Client(userID++, "Fifth", "lastName", userID - 5, 
                    new PatientData(BLOOD_TYPE.Group_A, "Fifth location", new List<AnalisisResult> () {  
                        new AnalisisResult(analisisID++, 37.9, "normal", null),
                        new AnalisisResult(analisisID++, 36.6, "normal", null)}
                    )),
                new Client(userID++, "Sixth", "lastName", userID - 5, new PatientData(BLOOD_TYPE.Group_AB, "Sixth location", new List<AnalisisResult> () {  
                ...
                new Client(userID++, "Seventh", "lastName", userID - 5, new PatientData(BLOOD_TYPE.Group_O, "Seventh location", new List<AnalisisResult> () {  
